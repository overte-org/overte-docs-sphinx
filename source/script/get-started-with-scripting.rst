...
.. note:: To debug a server entity script you should instead use the :ref:`Server Entity Script Log<server entity script log>` to view the output of your script.
