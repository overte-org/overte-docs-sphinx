<div class="admonition warning">
    ...
    <p>This document is slightly outdated. FIXME: Mentions welcome domain, welcome domain url malformed</p>
</div>

# Tutorial: Create a Portal

Portals in Overte transport you to the domain of your choice. You can use these portals to travel to a domain you visit frequently instead of using the **Places** app on your HUD or Tablet.
