...
+-------------------+-----------------------------------------------+
| Toggle Mouselook  | Must enable mouse look in controller settings |
|                   | and then use ``M`` to toggle.                 |
+-------------------+-----------------------------------------------+
...
| Paste Entity                              | ``CTRL`` + ``V``              |
+-------------------------------------------+-------------------------------+
| Toggle Local/World Transform              | ``T``                         |
+-------------------------------------------+-------------------------------+
