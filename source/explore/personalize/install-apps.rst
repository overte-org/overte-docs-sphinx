...
If you can't find an app for what you'd like to do, you can [create your own](../../create/applications). You can easily [load your own application as a script](../../script/get-started-with-scripting#running-scripts-window), or add it to our [Community Apps](https://github.com/overte-org/community-apps) to make it available to everyone via the More app.
...
* [Our Apps](#our-apps)
	* [Spectator Camera: Record or Livestream in Overte](#spectator-camera)
...
The Body Paint app lets your paint your environment, your own avatar, or even another user's avatar. [Use the instructions above](#install-tablet-apps) to install the Fingerpaint app.
